  ...
  persist(
    (set, get) => ({
      ...
      setOauthProxyMode: async (mode) => {
        ...
        try {
          await ApiService.config.update({ oauthProxyMode: mode })
        } catch (error) {
      ...
      setLanguage: async (language) => {
        ...
        try {
          await ApiService.config.update({ language: language })
        } catch (error) {
      ...
      setAutoStart: async (enabled) => {
        ...
        try {
          await ApiService.config.update({ autoStart: enabled })
        } catch (error) {
      ...
      setAutoStartProxy: async (enabled) => {
        ...
        try {
          await ApiService.config.update({ autoStartProxy: enabled })
        } catch (error) {
      ...
      updateConfig: async (updates) => {
        ...
        set({ config: newConfig as AppConfig })
